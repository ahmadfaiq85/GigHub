...
{ 
    ...
    public class GigRepositoryTests
    {
        ...
        [TestMethod]
        public void GetUpcomingGigByArtist_GigIsCancelled_ShouldNotBeReturn()
        {
            var gig = new Gig() { DateTime = DateTime.Now.AddDays(1), ArtistId = "1" };
            gig.Cancel();
        ...
        [TestMethod]
        public void GetUpcomingGigByArtist_GigIsForADifferentArtist_ShouldNotBeReturn()
        {
            var gig = new Gig() { DateTime = DateTime.Now.AddDays(1), ArtistId = "1" };
        ...
        [TestMethod]
        public void GetGigUserAttending_UpcomingGigUserAttending_ShouldBeReturned()
        {
            var gig = new Gig() { DateTime = DateTime.Now.AddDays(1) };
            var attendance = new Attendance { Gig = gig, AttendeeId = "1" };
